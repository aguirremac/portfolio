...
const Home = ({ setSelectedPage }: Props) => {
  ...
  return (
    ...
    <div className="text-[#C9C0A5] md:h-[35%] md:p-10 rounded-xl bg-black/20 flex flex-col items-center justify-center md:justify-center font-mont">
    ...
    <p className="font-light text-xs md:text-lg ">FRONT-END DEVELOPER  •  VIDEO EDITOR</p>
        ...
        {/* RIGHT SECTION */}
      <div className="md:h-screen flex flex-col items-center md:items-start justify-start md:justify-center px-5 mt-14">
      ...
      <button className={`mt-10 flex  gap-2 rounded-xl border-2 border-[#2877b5]/20 text-[#C9C0A5] py-3 px-5 text-sm transition duration-100 ease-in-out hover:bg-gradient-to-r hover:from-[#1C1F1B] hover:to-[#2877b5] hover:border-[#1C1F1B]  cursor-pointer  hover:text-[#c9c0a5] active:scale-110 `}
            >Explore More
    </button>
    </div> 
    </div>
